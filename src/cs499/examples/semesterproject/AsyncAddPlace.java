...
public class AsyncAddPlace extends AsyncTask<String, String, String>
{
	String[] schools;
    ...
    public AsyncAddPlace (Activity activityContext, String url, List<NameValuePair> pairs)
    {
    ...
    public AsyncAddPlace () {}
    
    protected void onPreExecute() {
    	progressDialog = new ProgressDialog(activityContext);
    	progressDialog.setMessage("Adding your organization/restaurant data...");
        progressDialog.show();
    }
